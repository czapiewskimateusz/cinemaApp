...
import com.czapiewski.cinemaapp.view.IMovies
...
class MoviesPresenter(private val movies: Movies, private val view :IMovies, private val context: Context) : ItemOnClickListener {
